    ...
    <div class="chapter">
      <section class="body-text">
        <div id="fulltext" class="text">
          ...
          <p>Das Projekt wird aktuell von der Uni Regensburg gehostet. Die verwendeten Schriften sind <emph>Crimson Text</emph>, geleitet von <a href="https://github.com/skosch/Crimson" target="_blank" rel="noopener">Sebastian Kosch</a> für die Editionstexte, sowie <a href="https://sourceforge.net/projects/linuxlibertine/" target="_blank" rel="noopener">Linux Biolinum</a> von Philipp H. Poll.</p>
        </div>
      </section>
    </div>
    <?php
